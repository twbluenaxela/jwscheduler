...
export const weekendData = [
  ...
  { date: "8/16", no: "74",  topic: "耶和華一直關注你",               cong: "新屋",     speaker: "謝文達", chair: "周家興", wt: "黃俊賢", read: "許文凱", host: "B" },
  { date: "8/23", no: "179", topic: "棄絕世俗的幻想，追求上帝真實的王國", cong: "新竹市北區", speaker: "王志明", chair: "林家明", wt: "王文哲", read: "包德安", host: "C", away: "鄭（八德 187）" },
  { date: "8/30", no: "110", topic: "家庭幸福以上帝為本",             cong: "新屋",     speaker: "謝文達", chair: "周家興", wt: "卓銘軒", read: "", host: "", away: "蔡（新化 42）" },
  ...
  { date: "9/20", no: "78",  topic: "在充滿怒氣的世界裡促進和睦",     cong: "新屋",     speaker: "郭建宏", chair: "謝文達", wt: "", read: "", host: "" },
  { date: "9/27", type: "special", topic: "特別演講：聖經可以怎樣幫助你？", cong: "—", speaker: "鍾明智", chair: "謝文達", wt: "", read: "周家興", host: "" },
